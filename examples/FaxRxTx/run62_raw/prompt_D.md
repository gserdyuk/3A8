...
|---|---|---|
| F48 | A stage of domain immersion and architecture/technology selection, [struck by the orchestrator: a duration] (DHT and the like were studied) | **not absorbed.** No dimension of catalogue 1.4 mandates a learning or technology-selection stage. `D1` mobilisation stands the team and its tooling up; it does not study a domain. Enters as its own branch |
