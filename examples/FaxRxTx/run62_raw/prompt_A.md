...
**Partial run.** Scope: the subtrees rooted at **N10** of the closed product model `HM61-1` — **15 elements**, listed in INPUT 1 with their parents and coverage. The model root `N00` and every other subtree are outside this batch: do not cross them and do not speculate about them. Per the partial-run rule, once-scoped and per-environment activities are **deferred**, not generated, and per-parent activities apply only to parents inside the batch.
...
|---|---|---|---|---|
| N10 | Inbound fax path | N00 | posited | — |
| N12 | Inbound conversion | N10 | posited | — |
| N13 | User email delivery | N10 | posited | — |
| L02 | Incoming-fax email delivery to user | N13 | accreted | F02,F05,F10 |
| L04 | PoP inbound TIFF receiver | N10 | accreted | F04,F38 |
| L05 | Delivery-mode selector per user configuration | N12 | accreted | F05 |
| L06 | Page-by-page TIFF attachment packager | N12 | accreted | F05 |
| L07 | TIFF-to-PDF converter | N12 | accreted | F05,F06 |
| L08 | OCR step within PDF conversion | N12 | accreted | F07 |
| L09 | Third-party OCR library adapter | N12 | accreted | F08 |
| L10 | OCR worker process | N12 | accreted | F09 |
| L11 | Conversion worker process | N12 | accreted | F11 |
| L12 | Email sending worker process | N13 | accreted | F11 |
| L55 | Email delivery outcome tracking | N13 | accreted | F46 |
| D01 | Fax number to user directory | N10 | derived | trigger:L02,L04 |
