...
**Partial run.** Scope: the subtrees rooted at **N11, N12** of the closed product model `HM57-1` — **26 elements**, listed in INPUT 1 with their parents and coverage. The model root `N01` and every other subtree are outside this batch: do not cross them and do not speculate about them. Per the partial-run rule, once-scoped and per-environment activities are **deferred**, not generated, and per-parent activities apply only to parents inside the batch.
...
|---|---|---|---|---|
| N11 | Import and export | N01 | posited | — |
| N12 | Publish and subscribe | N01 | posited | — |
| A010 | Subscription entitlement model (viewable data, export options) | N12 | accreted | I-9,G-13,G-13.5,D-5 |
| A051 | Record import pipeline (parse, map, validate, load) | N11 | accreted | G-12,G-12.1,G-12.4,P-1,P-5,P-11,P-11.2,P-19,L-1,L-5,L-10.2,L-15 |
| A052 | Record export pipeline (serialise, deliver) | N11 | accreted | G-12,G-12.1,P-12,D-5,I-8 |
| A053 | Excel import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A054 | CSV import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A055 | Numbers import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A056 | XML import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A057 | Tab-delimited import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A058 | IDoc import and export adapter | N11 | accreted | G-12.1,G-12.2,P-19,L-15,D-5 |
| A060 | Record selection for import and export | N11 | accreted | G-12.3,D-5 |
| A061 | Import validation result report | N11 | accreted | G-12.4 |
| A062 | Publication registry (what, to whom, attribute tier) | N12 | accreted | G-13,G-13.1,G-13.2,G-13.3,G-13.4,P-17,L-12,I-1 |
| A063 | Published-data access evaluation | N12 | accreted | G-13,G-13.5,P-17,L-12 |
| A064 | Hierarchy-level publication | N12 | accreted | G-13.1 |
| A065 | Basic and full attribute tiers | N12 | accreted | G-13.2,D-2 |
| A066 | Publication for a group of records | N12 | accreted | G-13.3 |
| A067 | Sharing target selection (individual, group, controlled group, public) | N12 | accreted | G-13.4 |
| A068 | User-defined group management | N12 | accreted | G-13.4 |
| A069 | Controlled group management by X-Customer | N12 | accreted | G-13.4,D-3 |
| A071 | Access request submission | N12 | accreted | G-13.6,G-13.7,D-2,D-2.1 |
| A072 | Access request approval and rejection by owner | N12 | accreted | G-13.7,D-2.1 |
| A085 | Import update mode for existing records | N11 | accreted | P-5,P-11.2,L-5,L-10.2 |
| A137 | Controlled group join request with X-Customer approval | N12 | accreted | D-3 |
| C09 | Publication overview and revocation | N12 | derived | trigger:A062 |
