...
**Partial run.** Scope: the subtrees rooted at **N13** of the closed product model `HM57-1` — **37 elements**, listed in INPUT 1 with their parents and coverage. The model root `N01` and every other subtree are outside this batch: do not cross them and do not speculate about them. Per the partial-run rule, once-scoped and per-environment activities are **deferred**, not generated, and per-parent activities apply only to parents inside the batch.
...
|---|---|---|---|---|
| N13 | Shared record management | N01 | posited | — |
| N14 | Identifier management | N13 | posited | — |
| N15 | Record lifecycle | N13 | posited | — |
| N16 | Record views and actions | N13 | posited | — |
| N17 | Duplicate handling | N13 | posited | — |
| N18 | Hierarchy management | N13 | posited | — |
| A003 | Identifier composition rules (prefix plus serial, per-kind length) | N14 | accreted | I-3,P-2,L-2 |
| A004 | Check digit calculation | N14 | accreted | I-3,P-2,L-2 |
| A073 | Single-record creation form driven by attribute sets | N15 | accreted | P-1,L-1,I-1 |
| A074 | Step-by-step record creation wizard | N15 | accreted | P-1,L-1 |
| A075 | Record cloning | N15 | accreted | P-1,L-1 |
| A079 | Draft saving of incomplete records | N15 | accreted | P-1.1,L-1.1 |
| A080 | Identifier registry per prefix | N14 | accreted | P-2,P-8,L-2 |
| A081 | Identifier assignment service (auto or manual at any creation step) | N14 | accreted | P-2,P-2.1,P-3,L-2,L-2.1,L-2.2,NFR-16,I-1 |
| A082 | Identifier reservation from auto-assign | N14 | accreted | P-2.2,L-2.3 |
| A083 | Assignment mode preference | N14 | accreted | P-3,L-3 |
| A084 | Record edit form with finalise action | N15 | accreted | P-4,P-5,L-4,L-5,I-1 |
| A087 | Prior-identifier reference on number change | N14 | accreted | P-5.2,L-5.1 |
| A090 | Record list view with filter and sort | N16 | accreted | P-7,P-7.1,P-7.2,L-6 |
| A091 | Single-record action menu | N16 | accreted | P-7.1,L-6.1 |
| A092 | Multi-record bulk action | N16 | accreted | P-7.2,L-6.2 |
| A093 | Identifier list view with filter and sort | N16 | accreted | P-8,L-7 |
| A094 | Duplicate detection engine | N17 | accreted | P-9,P-9.1,L-8 |
| A095 | Duplicate review and resolution screen | N17 | accreted | P-9,L-8 |
| A097 | Creation-time duplicate alert | N17 | accreted | P-9.1,L-8.1 |
| A098 | Duplicate report for completed records | N17 | accreted | P-9.1,L-8.1 |
| A099 | Record status management | N15 | accreted | P-10,P-10.2,P-11.5,L-9,L-9.2,I-1 |
| A100 | Identifier status management | N14 | accreted | P-10,P-10.1,P-10.3,L-9,L-9.1 |
| A102 | Record-to-identifier status synchronisation | N14 | accreted | P-10.1,L-9.1 |
| A104 | Out-of-use and reuse date display | N14 | accreted | P-10.3,L-9.3 |
| A106 | Hierarchy tree editor (create, edit, view) | N18 | accreted | P-11,P-11.4,L-10 |
| A107 | Drag-and-drop hierarchy canvas | N18 | accreted | P-11,L-10 |
| A108 | Hierarchy import handling | N18 | accreted | P-11,P-11.2,L-10,L-10.2 |
| A112 | Hierarchy status impact analysis | N18 | accreted | P-11.5,L-10.3 |
| A114 | Hierarchy export and print rendering | N18 | accreted | P-12,L-11 |
| A121 | Record ownership transfer | N13 | accreted | P-18,L-14 |
| C15 | Hierarchy integrity check (cycles, orphans) | N18 | derived | trigger:A129,A106 |
