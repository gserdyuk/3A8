...
<div class="stack">
  ...
  <div class="row"><span class="idx">0</span><div class="body"><div class="t">No method &times;10</div><div class="x">The document and the assumption log handed to a bare agent ten times, no sensor definition, one permitted file read each. The floor the chain must beat to be worth its cost: on repeatability it is &times;1.92 across runs against the chain's &times;1.0026.</div></div></div>
